<template>
  ...
  <template v-for="(friend, index) in friends" :key="index">
    <div class="info-box">
      <router-link :to="{path:'/friendInfo',query:{userId:friend.userId}}" >
        <img :src="defaultImg" class="img">
      </router-link>
      <div class="mid-box">
        <router-link :to="{path:'/friendInfo',query:{userId:friend.userId}}" class="name">{{friend.name}}</router-link>
      ...
      <div class="right-box">
        <div class="delete-box" @click="dialogVisible = true">
          <el-icon><Remove /></el-icon>
          <span class="span">Delete Friend</span>
        </div>
      </div>
    </div>
    <div class="line"></div>
    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="danger" @click="dialogVisible = false;deleteFriend(friend.uid)">
            Confirm
          </el-button>
        </div>
      </template>
