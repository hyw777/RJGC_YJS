<template>
  <div class="merchant">
    <div class="img-box">
      <img class="img1" :src="filePath(baseInfo.imageList[0])" alt="img1">
      <img class="img2" :src="filePath(baseInfo.imageList[1])" alt="img2">
      <img class="img3" :src="filePath(baseInfo.imageList[2])" alt="img3">
    </div>
    <div class="info-box">
